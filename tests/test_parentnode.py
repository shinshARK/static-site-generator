...
class TestParentNode(unittest.TestCase):
    ...
    def test_parent_with_props(self):
        ...
        self.assertEqual(
            node.to_html(),
            '<div id="main" class="container"><span>text</span></div>'
    )
    ...
    def test_repr_with_children_no_props(self):
        ...
        self.assertEqual(repr(node), "ParentNode(tag='p', children=[LeafNode(tag='span', value='child', props=None)], props=None)")

    def test_repr_no_children_with_props(self):
        node = ParentNode("a", [], {"href": "#"})
        self.assertEqual(repr(node), "ParentNode(tag='a', children=[], props={'href': '#'})")

    def test_repr_with_children_with_props(self):
        child = LeafNode("b", "bold")
        node = ParentNode("div", [child], {"class": "container"})
        self.assertEqual(repr(node), "ParentNode(tag='div', children=[LeafNode(tag='b', value='bold', props=None)], props={'class': 'container'})")
    ...
    def test_repr_with_multiple_children(self):
        ...
        self.assertEqual(repr(node), "ParentNode(tag='ul', children=[LeafNode(tag='li', value='item1', props=None), LeafNode(tag='li', value='item2', props=None)], props=None)")
    ...
    def test_repr_with_nested_parent_node(self):
        ...
        self.assertEqual(repr(node), "ParentNode(tag='div', children=[ParentNode(tag='span', children=[LeafNode(tag=None, value='inner', props=None)], props=None)], props=None)")

    def test_repr_no_tag(self):
        node = ParentNode(None, [LeafNode("p", "text")])
        self.assertEqual(repr(node), "ParentNode(tag=None, children=[LeafNode(tag='p', value='text', props=None)], props=None)")

    def test_repr_empty_props(self):
        node = ParentNode("div", [LeafNode("span", "text")], {})
        self.assertEqual(repr(node), "ParentNode(tag='div', children=[LeafNode(tag='span', value='text', props=None)], props={})")
